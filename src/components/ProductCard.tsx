...
const ProductCard: React.FC<Props> = ({ product }) => {
  ...
  const handleFavorite = (e: React.MouseEvent) => {
    e.stopPropagation(); // 🛑 prevents triggering hover or flip
  ...
  return (
    <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-md hover:shadow-2xl transition-all duration-300 p-4 group relative cursor-pointer">
      {/* Product Image */}
